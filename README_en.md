...
Welcome to H Band! H Band is a free application developed by Shenzhen Veepoo Technology Co., LTD (hereinafter referred to as "H Band", "we","us","our service" or "our product").
...
| :-------------------------------- | :----------------------------------------------------------- | :--------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Background Location**           | **GPS positioning information of the application in the background** | **Sensitive information, non-essential** | **-The App’s GPS motion scene records your motion trajectory through GPS coordinates<br />-When the App is in the background or exits the foreground, the App can also normally obtain GPS motion trajectory information through background positioning** | **In non-login mode, your GPS positioning information will not be uploaded to the server, but will only be retained in local data until you uninstall the application or clear the application data<br />GPS motion trajectory information will be uploaded in the logged-in state server, will be retained until you request removal of the information or until your account is deleted, whichever is earlier. ** |
...
In order to provide you with certain functions and services, we may ask you in advance to authorize us to call relevant system permissions. You can view the specific personal information access permissions and their open status item by item in "My"-"Permission Management" on the H Band App, and choose to enable or disable permissions in the system settings of your mobile device.
...
The personal data processed by H Band is stored in the H Band account and can be accessed in the app. Your health data will be anonymized, that is, it cannot be identified or associated with an account, and will be used by the H Band Health Institute team as raw data for research and analysis in the health field to advance scientific research.
...
By creating an H Band account (including online accounts-register via email or mobile number, and local accounts), you can better use our products and services. Through this account, you can also manage your own content and preferences, as well as the measurement data collected by the product.
...
We recommend that you log in to your H Band account regularly and confirm that your personal data is accurate and up-to-date. If you have any questions about the accuracy of the data, please let us know and we will take steps to correct or delete the inaccurate data.
...
For example, through your privacy settings, you can limit the visibility of your information to other users of the service; using your notification settings, you can limit the notifications you receive from us; under your application settings, you can revoke you Access to third-party applications previously linked to the H Band account; use the H Band application to unbind the device from your account at any time. You can also close the corresponding system permissions through the steps in "Appendix 1 Permission Application Instructions", thereby denying us the collection and processing of corresponding personal information.
...
If you have cancelled your H Band account and want to use our products and services again, just create a new account.
...
H Band's products and services are provided to the general public. We recognize the importance of taking additional measures to protect the privacy of minors.
...
| ACCESS_BACKGROUND_LOCATION<br />ACCESS_COARSE_LOCATION | Bluetooth search<br />Using GPS location function<br />Background positioning function | Android 6.0-Android12 requires the positioning function to search surrounding devices through Bluetooth<br />The GPS movement of the App and the movement of the bracelet require GPS for positioning and recording movement trajectories<br />In order to support GPS movement and record movement trajectories, the App will be in the background after turning on GPS movement. Or you can use the background positioning function to record GPS movement trajectory information normally after exiting the foreground. | Location information              | Yes                  | Settings-Applications-Turn off location                  |
